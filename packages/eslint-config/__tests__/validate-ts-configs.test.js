...
describe('Validate TS configs', () => {
  it('Validate eslint-config-mengtong/typescript', async () => {
  ...
  it('Validate eslint-config-mengtong/typescript/vue', async () => {
  ...
  it('Validate eslint-config-mengtong/essential/typescript', async () => {
  ...
  it('Validate eslint-config-mengtong/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-mengtong/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-mengtong/typescript/node', async () => {
