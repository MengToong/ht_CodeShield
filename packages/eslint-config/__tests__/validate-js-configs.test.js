...
describe('Validate JS configs', () => {
  it('Validate eslint-config-mengtong', async () => {
  ...
  it('Validate eslint-config-mengtong/es5', async () => {
  ...
  it('Validate eslint-config-mengtong/vue', async () => {
  ...
  it('Validate eslint-config-mengtong/essential', async () => {
  ...
  it('Validate eslint-config-mengtong/essential/es5', async () => {
  ...
  it('Validate eslint-config-mengtong/essential/react', async () => {
  ...
  it('Validate eslint-config-mengtong/essential/vue', async () => {
  ...
  it('Validate eslint-config-mengtong/node', async () => {
